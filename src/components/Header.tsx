...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="container-lux flex items-center justify-between px-7 lg:px-20">
          <Link
            to="/"
            aria-label="The Interior & Exterior Solution home"
            className="flex items-center justify-start gap-3 py-1 pr-3 sm:pr-5"
          >
            <img
              src="/v5logo.png"
              ...
              className="h-[46px] w-auto max-w-[190px] object-contain sm:h-[52px]"
            />
            <span
              className={`hidden text-[14px] leading-none tracking-[0.18em] text-forest/80 sm:inline ${transparent ? "text-ivory/90" : "text-forest/80"}`}
