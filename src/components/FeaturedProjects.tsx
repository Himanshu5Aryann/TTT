        ...
        <Link to={`/work/${featured[0].slug}`} data-cursor="View Project" className="group block relative">
          ...
          <div className="overflow-hidden">
            <img
              ...
              loading="lazy"
              className="w-full h-[52vw] max-h-[720px] min-h-[320px] object-cover group-hover:scale-[1.04] transition-transform duration-[1200ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
            />
          </div>
